...
class TwigController extends AbstractController
{
    ...
    private function getOffreFormations(): array
    {
        $tab = array (
            'mentions' => array(                       // tableau des mentions   -> $tab['mentions']
                ...
                'ISN' => array(                      //     mention  Bio       -> $tab['mentions']['Bio']
                    'nom' => 'INFORMATIQUE SCIENCE DU NUMERIQUE',
                    'parcours' => array(
                        'Genie du mal',
                        'Grand sage du code en bonne et due forme',
                        'Diplomate Informatique',
                    ),
                    'responsable' => 'MN',
                ),
            ),
    ...
    public function vue6Action(): Response
    {
        $args = array(
            'prenom' => 'Arthur',
            'mail' => 'ArthurPlusFortQueGille@l3.fr',
    ...
    public function vue6bisAction(): Response
    {
        $argsbis = array(
            'prenom' => 'Arthur',
            'mail' => 'ArthurPlusFortQueGille@l3.fr',
        ...
        return $this->render('Sandbox/twig/vue6bis.html.twig ',$argsbis);
    }
